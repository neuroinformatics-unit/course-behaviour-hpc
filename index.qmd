...
::: aside
see also [SLEAP's guide for remote training](http://legacy.sleap.ai/guides/remote.html)
:::
...
::: {.fragment}
```{.bash code-line-numbers=false filename="mouse044_task1_annotator1.training_job"}
...
```{.bash filename="sleap_infer_array_slurm.sh" code-line-numbers="14|24-26|34-40"}
#!/bin/bash
